 ...
 */
export async function login (username,password,con){
    /*
...
export async function register (username,password,con){
     ...
     */
    const {exists} = await getUserInfo(username,con);
 ...
 */
export async function getUserInfo(username,con){
...
/*
    ...
    throws
        ...
        if result is empty
 */
export async function getPasswordHash(uid,con){
...
/*
    ...
    params:
        ...
        object:con --> the connection to the database, uses library mysql
 */
export async function saveUser(username,hash,con){
    ...
    return await new Promise(function(resolve, reject) {
        ...
        con.query(query_str, async function (err) {

            if(err)
                reject(err);
            try {
                const {uid} = await getUserInfo(username, con);
                resolve(uid);
            }catch (err) {
                reject(err);
            }
